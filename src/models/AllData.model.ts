...
export interface GetListSearchGoods {
  query?: str | null;
  page?: num;
  size?: num;
}
...
export interface ValidSteps extends BuyersListType {
  billTypeId?: SelectOption;
  billSerial?: str | num;
  subjectType?: str;
...
export interface BillItems {
  ...
  itemValueIncreasedTaxPrice?: str | num;
  otherTaxRate?: str | num;
  otherTaxPrice?: str | num | null | undefined;
  otherTaxSubject?: str | num;
  otherLegalFundsRate?: str | num;
  otherLegalFundsPrice?: str | num | null | undefined;
...
export interface SerGetBillInitializeData {
  billStatuses: SelectOption[];
  currencies: SelectOption[];
  flightTypes: SelectOption[];
  paymentTypes: SelectOption[];
  personTypes: SelectOption[];
  settlementTypes: SelectOption[];
  subjectTypes: SelectOption[];
  types: SelectOption[];
  unitTypes: SelectOption[];
}
export interface PropsBillingInformation {
  billInitializeData?: SerGetBillInitializeData;
  // setInputsdata?: React.Dispatch<
  //   React.SetStateAction<SerGetBillInitializeData | undefined>
  // >;
}
