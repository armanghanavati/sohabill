...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
            ...
            className={cn(
                "tw-z-50 tw-min-w-[8rem] tw-overflow-hidden tw-rounded-md tw-border tw-bg-white tw-p-1 tw-text-mainBlack tw-shadow-md",
...
>(({ className, children, ...props }, ref) => (
    <DropdownMenuPrimitive.RadioItem
        ...
        {...props}
    >
        <span className="tw-absolute tw-left-2 tw-flex tw-h-3.5tw- w-3.5 tw-items-center tw-justify-center">
            <DropdownMenuPrimitive.ItemIndicator>
