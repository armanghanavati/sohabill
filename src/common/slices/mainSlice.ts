...
const mainSlice: MainState = createSlice({
  name: "main",
  initialState,
  reducers: {
    ...
    handleLoading: (state, actions: PayloadAction<{ loading?: boolean }>) => {
...
export const selectQuseTionModal = (state: RootState) =>
  state.main.showQuestionModal;
