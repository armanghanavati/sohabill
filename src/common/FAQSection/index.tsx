...
const FAQSection: React.FC = () => {
  ...
  const questionsList: FAQType[] = [
    ...
    {
      question:
        "آیا می‌توان در استفاده از خدمات دیبا، همچنان از طریق شرکت معتمد صدرتحساب ارسال کرد؟",
      answer:
        "بله، هر مودی برای هر کسب وکار خود باید حداقل یک حافظه مالیاتی دریافت کند؛ در این صورت صودتحساب‌های صادره او در این حافظه قرار می‌گیرد.",
    },
    {
      question:
        "آیا امکان صدور صورتحساب ارجاعی (اصلاحی، برگشت از فروش و ابطال) از طریق دیبا وجود دارد؟",
      answer:
        "بله، هر مودی برای هر کسب وکار خود باید حداقل یک حافظه مالیاتی دریافت کند؛ در این صورت صودتحساب‌های صادره او در این حافظه قرار می‌گیرد.",
    },
    {
    ...
    {
      question: "مزیت دیبا نسبت به سایر بسترهای ارسال صورتحساب چیست؟",
      answer:
        "بله، هر مودی برای هر کسب وکار خود باید حداقل یک حافظه مالیاتی دریافت کند؛ در این صورت صودتحساب‌های صادره او در این حافظه قرار می‌گیرد.",
    },
    {
      ...
      answer:
        "خیر، کاربر می‌تواند بدون قرارداد با معتمد از طریق دیبا و با واسطه شرکت معتمد صورتحساب ارسال کند. علاوه بر این کاربر می‌تواند از روش ارسال مستقیم از طریق دیبا نیز استفاده کند.",
    },
  ];
  ...
  return (
    <div className="tw-flex tw-flex-col tw-gap-3 lg:tw-gap-5">
      ...
      <h2 className=" tw-pb-0	tw-text-center tw-font-vazir tw-text-sm tw-text-gray-800 lg:tw-pb-8 lg:tw-text-2xl">
        هر آنچه باید در مورد دیبا و ارسال صورتحساب از طریق آن را بدانید.
      </h2>
