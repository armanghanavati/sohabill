...
const taxTabContent: {
  ...
  linkUrl: string;
}[] = [
    {
      ...
      description: "ابتدا در سایت سها اطلاعات خود را وارد و ثبت‌نام نمایید.",
    ...
    {
      title: "ذخیره کد حافظه مالیاتی در سها",
      description: "ذخیره کد حافظه مالیاتی در سهابیل در قسمت پروفایل کاربری .",
      linkTitle: "ذخیره کد حافظه مالیاتی در سها",
      linkUrl: "",
    },
    {
  ...
  return (
    <div className="tw-pt-12 md:tw-pt-44">
      ...
      <div className="tw-relative tw-h-full tw-w-full tw-bg-white md:tw-bg-primary-ghost">
        <div className="tw-container tw-flex tw-flex-col tw-gap-6 md:tw-py-8">
          ...
          <div className="tw-flex tw-w-full tw-items-center tw-justify-center ">
            ...
            >
              <TabsList className="tw-grid tw-gap-2 tw-rounded-lg tw-bg-gray-100 md:tw-grid-cols-4 md:tw-rounded-full md:tw-bg-white ">
              ...
              {tabsArrays.map((tab) => (
                <TabsContent
                  key={tab.value}
                  value={tab.value}
                  className="tw-container tw-flex tw-w-full tw-flex-col tw-justify-center tw-gap-y-6 md:tw-gap-x-8 md:tw-gap-y-24 lg:tw-flex-row lg:tw-flex-wrap lg:tw-gap-x-0"
                >
                  {tab.array.map(
                    (
      ...
      <div className="tw-container tw-flex tw-w-full tw-flex-col tw-items-center tw-justify-center tw-gap-[76px] tw-pb-12 md:tw-gap-[88px]">
        <div className="tw-h-full tw-w-full md:tw-w-full">
