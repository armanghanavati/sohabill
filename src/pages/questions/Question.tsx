                  ...
                  >
                    <Accordion.Header className="fs-5 fw-bold lh-lg textPrimary py-1 px-2 my-1">
                      <span
                        ...
                        style={{ transform: "scale(-1, 1)" }}
                      >
                        روش ارسال صورتحساب الکترونیکی توسط سامانه دیبا در کدام
                    ...
                    <Accordion.Body
                      ...
                      className="textJustify mx-2 lh-lg textPrimary"
                    >
                      سامانه پایانه فروشگاهی دیبا به دو روش می‌تواند
                      صورتحساب‌های الکترونیک مؤدیان را به کارپوشه آن‌ها در
                      سامانه مؤدیان ارسال نماید. روش اول: مؤدیان می‌توانند
                      صورتحساب‌های خود را در بستر رابط کاربری سامانه مذکور ثبت
                      نموده و دیبا صورتحساب‌ها را از طریق کلید مؤدی با روش ارسال
                      مستقیم به کارپوشه سامانه مؤدیان ارسال نماید. روش دوم: اگر
                      مؤدیان با شرکت‌های معتمد همکاری نموده و قصد ارسال
                      صورتحساب‌های الکترونیک خود را از طریق شرکت معتمد دارند،
                      سامانه دیبا می‌تواند صورتحساب‌های مؤدیان را به قالب‌های
                      ارسالی شرکت‌های معتمد تبدیل کرده و در اختیار شرکت معتمد
                      طرف قرارداد مودی قرار دهد.
                    </Accordion.Body>
                  </Accordion.Item>
                </Col>
                <Col xl="12" className="rounded my-2">
                  ...
                  >
                    <Accordion.Header className="fs-5 fw-bold lh-lg textPrimary py-1 px-2 my-1">
                      <span
                        ...
                        style={{ transform: "scale(-1, 1)" }}
                      >
                        در روش ارسال مستقیم صورتحساب از طریق سامانه دیبا چه
                    ...
                    >
                      ...
                      نمایند. در گام بعدی، سامانه دیبا کلید خصوصی و عمومی مؤدیان
